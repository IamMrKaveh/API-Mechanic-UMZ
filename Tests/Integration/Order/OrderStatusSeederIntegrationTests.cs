...
public class OrderStatusSeederIntegrationTests(PostgresContainerFixture fixture) : IAsyncLifetime
{
    private readonly PostgresContainerFixture _fixture = fixture; private DBContext _context = null!; private IServiceScopeFactory _scopeFactory = null!; private OrderStatusSeeder _sut = null!;
