...
public class OrderStatusRepositoryIntegrationTests(PostgresContainerFixture fixture) : IAsyncLifetime
{
    private readonly PostgresContainerFixture _fixture = fixture; private DBContext _context = null!; private OrderStatusRepository _sut = null!;
