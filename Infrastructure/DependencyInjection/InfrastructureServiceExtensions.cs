...
using Infrastructure.Wallet.BackgroundServices;
...
public static class InfrastructureServiceExtensions
{
    ...
    {
        services.Configure<LiaraStorageSettings>(configuration.GetSection(LiaraStorageSettings.SectionName));
    ...
    private static void AddBackgroundServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHostedService<WalletReservationExpiryService>();
