    ...
    IDateTimeProvider dateTimeProvider) : ICheckoutPaymentStrategy
{
        ...
        CancellationToken ct)
    {
        ...
        PaymentInitiationResult initResult;
        try
        {
            initResult = await paymentService.InitiatePaymentAsync(
        ...
        return ServiceResult<CheckoutResultDto>.Success(orderResult with
        {
            ...
            PaymentAuthority = initResult.Authority,
            PaymentTransactionId = initResult.TransactionId,
            IsPaid = false,
