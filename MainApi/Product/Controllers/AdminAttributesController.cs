...
public class AdminAttributesController : BaseApiController
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAttributeType([FromBody] Application.Product.Features.Shared.CreateAttributeTypeDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAttributeType(int id, [FromBody] Application.Product.Features.Shared.UpdateAttributeTypeDto dto)
    {
    ...
    public async Task<IActionResult> CreateAttributeValue(int typeId, [FromBody] Application.Product.Features.Shared.CreateAttributeValueDto dto)
    {
