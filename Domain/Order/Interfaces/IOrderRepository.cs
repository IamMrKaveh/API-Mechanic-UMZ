...
{
    Task<Aggregates.Order?> FindByIdAsync(OrderId orderId, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<Aggregates.Order>> FindByUserIdAsync(UserId userId, CancellationToken ct = default);
