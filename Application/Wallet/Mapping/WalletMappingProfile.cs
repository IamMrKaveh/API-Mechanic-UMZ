...
public class WalletMappingProfile : Profile
{
    ...
    {
        CreateMap<Domain.Wallet.Aggregates.Wallet, WalletDto>()
        ...
        CreateMap<Domain.Wallet.Aggregates.Wallet, WalletBalanceResponse>()
        ...
        CreateMap<WalletLedgerEntry, WalletLedgerEntryDto>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
            .ForMember(dest => dest.AmountDelta, opt => opt.MapFrom(src => src.Amount))
