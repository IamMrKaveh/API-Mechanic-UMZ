...
public interface IMediaService
{
    ...
    Task<Media> AttachFileToEntityAsync(Stream stream, string fileName, string contentType, long length, string entityType, int entityId, bool isPrimary = false, string? altText = null);
