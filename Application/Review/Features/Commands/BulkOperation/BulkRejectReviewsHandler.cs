...
public sealed class BulkRejectReviewsHandler(
    IReviewRepository reviewRepository,
    IUnitOfWork unitOfWork)
    : ICommandHandler<BulkRejectReviewsCommand, BulkOperationResult>
{
    public async Task<ServiceResult<BulkOperationResult>> Handle(
        BulkRejectReviewsCommand request, CancellationToken ct)
    {
