...
public class GetDiscountsHandler : IRequestHandler<GetDiscountsQuery, ServiceResult<PaginatedResult<DiscountCodeDto>>>
{
    ...
    public GetDiscountsHandler(IDiscountRepository discountRepository, IMapper mapper)
    {
        _discountRepository = discountRepository;
        _mapper = mapper;
    }

    public async Task<ServiceResult<PaginatedResult<DiscountCodeDto>>> Handle(GetDiscountsQuery request, CancellationToken cancellationToken)
    {
