...
public class DeleteCategoryGroupHandler : IRequestHandler<DeleteCategoryGroupCommand, ServiceResult>
{
    private readonly ICategoryRepository _categoryRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMediaService _mediaService;
    private readonly ILogger<DeleteCategoryGroupHandler> _logger;

    public DeleteCategoryGroupHandler(
        ICategoryRepository categoryRepository,
        IUnitOfWork unitOfWork,
        IMediaService mediaService,
        ILogger<DeleteCategoryGroupHandler> logger)
    {
    ...
    public async Task<ServiceResult> Handle(
        DeleteCategoryGroupCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            category.RemoveGroup(request.GroupId, request.DeletedBy);
