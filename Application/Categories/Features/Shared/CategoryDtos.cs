...
public class CategoryViewDto
{
    ...
    public List<CategoryGroupSummaryDto> CategoryGroups { get; set; } = new();
...
public class CategoryTreeDto
{
    ...
    public string? IconUrl { get; set; }
    public int SortOrder { get; set; }
    public IReadOnlyList<CategoryGroupTreeDto> Groups { get; set; } = [];
}
...
public class CategoryWithGroupsDto
{
    ...
    public DateTime? UpdatedAt { get; set; }
    public string? RowVersion { get; set; }
    public IReadOnlyList<CategoryGroupSummaryDto> Groups { get; set; } = [];
}