...
public class AdminCategoryGroupService : IAdminCategoryGroupService
{
    ...
    private readonly IAppLogger<AdminCategoryGroupService> _logger;
    ...
    public AdminCategoryGroupService(
        ...
        IAppLogger<AdminCategoryGroupService> logger)
    {
    ...
    public async Task<ServiceResult<CategoryGroupViewDto>> CreateAsync(CategoryGroupCreateDto dto)
    {
        ...
        if (dto.IconFile != null)
        {
            try
            {
                await _mediaService.AttachFileToEntityAsync(dto.IconFile.Content, dto.IconFile.FileName, dto.IconFile.ContentType, dto.IconFile.Length, "CategoryGroup", group.Id, true);
                await _unitOfWork.SaveChangesAsync();
            }
            catch (Exception ex)
            {
    ...
    public async Task<ServiceResult> UpdateAsync(int id, CategoryGroupUpdateDto dto)
    {
        ...
        if (dto.IconFile != null)
        {
            ...
            await _mediaService.AttachFileToEntityAsync(dto.IconFile.Content, dto.IconFile.FileName, dto.IconFile.ContentType, dto.IconFile.Length, "CategoryGroup", id, true);
        }
