...
public class DeleteAttributeTypeHandler : IRequestHandler<DeleteAttributeTypeCommand, ServiceResult>
{
    ...
    public DeleteAttributeTypeHandler(IAttributeRepository repository, IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<ServiceResult> Handle(DeleteAttributeTypeCommand request, CancellationToken cancellationToken)
    {
