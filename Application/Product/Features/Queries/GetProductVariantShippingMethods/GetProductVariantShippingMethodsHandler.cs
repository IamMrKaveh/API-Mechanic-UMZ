...
public class GetProductVariantShippingMethodsHandler : IRequestHandler<GetProductVariantShippingMethodsQuery, ServiceResult<ProductVariantShippingInfoDto>>
{
    private readonly IProductRepository _productRepository;
    private readonly IShippingMethodRepository _shippingMethodRepository;
    private readonly ILogger<GetProductVariantShippingMethodsHandler> _logger;

    public GetProductVariantShippingMethodsHandler(
        IProductRepository productRepository,
        IShippingMethodRepository shippingMethodRepository,
        ILogger<GetProductVariantShippingMethodsHandler> logger)
    {
    ...
    public async Task<ServiceResult<ProductVariantShippingInfoDto>> Handle(GetProductVariantShippingMethodsQuery request, CancellationToken cancellationToken)
    {
        try
        {
