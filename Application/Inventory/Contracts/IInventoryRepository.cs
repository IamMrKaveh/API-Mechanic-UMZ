...
public interface IInventoryRepository
{
    ...
    /// </summary>
    Task AddTransactionsAsync(IEnumerable<InventoryTransaction> transactions, CancellationToken ct = default);

    /// <summary>
    /// دریافت تراکنش با شناسه
    /// </summary>
    Task<InventoryTransaction?> GetByIdAsync(int id, CancellationToken ct = default);
    ...
    /// دریافت آمار موجودی
    /// </summary>
    Task<InventoryStatistics> GetStatisticsAsync(CancellationToken ct = default);
